                           ...
                           <form class="form-horizontal" method="post">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" id="seats" name="seats" placeholder="Nombre de places" required min=2 max=9 oninvalid="setCustomValidity('Le nombre de places doit etre compris entre 2 et 9.')">
                                    </div>
                                </div>
                            </div>
                            <!-- /.box-body -->
